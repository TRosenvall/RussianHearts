...
protocol HighscoresMainViewDelegate: AnyObject {
    func backButtonTapped()
}

class HighscoresMainView: UIView, MainView {

    // MARK: - Properties
    weak var delegate: HighscoresMainViewDelegate?
